...
local adWidth = 14				-- additional width for selected nameplate (hpWidth + adWidth)
local adHeight = 4				-- additional height for selected nameplate (hpHeight + adHeight)
...
local function UpdateObjects(frame)
	...
	frame.hp.hpbg2:SetVertexColor(BGr*0.36, BGg*0.36, BGb*0.36)
